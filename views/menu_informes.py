...
def pantalla_informes(ventana, volver_menu):
    ...
    def informe_partidos_fecha():
        ...
        def generar_informe():
            ...
            try:
                ...
                for id_partido, fecha_p, equipo1, equipo2, jornada, fase, hora in resultados:
    ...
    def informe_tabla_grupo():
        ...
        grupos = [g[1] for g in get_grupo()]  # Obtener nombres de grupos
    ...
    def informe_cuadro_equipo():
        ...
        equipos = [e[1] for e in get_equipo()]  # Obtener nombres de equipos
        ...
        def generar_informe():
            ...
            try:
                ...
                if not partidos:
                    ...
                    for fecha_p, fase, eq1, g1, eq2, g2 in partidos:
        ...
        def generar_informe():
            ...
            try:
                ...
                if not partido:
                    ...
                    fecha_p, hora, eq1, eq2, jornada, fase = partido
